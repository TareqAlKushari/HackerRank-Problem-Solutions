...
Please note that you will get the data from page 1 as any given IP just has a single record (if any). 
Page 1 is the default page returned on an API hit. No further page hits are required.
...
if __name__ == '__main__':
    print(ipTracker("172.217.20.46"))  # Output: US
    print(ipTracker("172.217.20.50"))  # Output: No Result Found
